...
export default function JourneyMap() {
  ...
  return (
    <main className="main-content" style={{flex: 1, minWidth: 0, height: '100%', display: 'flex', flexDirection: 'column', overflow: 'hidden', background: 'var(--white)', position: 'relative', zIndex: 5}}>
      <Header />
