...
export default function YoutubePage() {
  ...
  const videos = [
    { id: 1, title: 'Market Research Fundamentals', author: 'Starweaver Academy', duration: '6:10' },
    { id: 2, title: 'Primary vs Secondary Research', author: 'Starweaver Academy', duration: '8:45' },
    { id: 3, title: 'Competitive Analysis Tutorial', author: 'Starweaver Academy', duration: '12:20' }
  ];
    ...
    <main className="pdf-main">
      ...
      <div className="pdf-toolbar">
        <div className="videos-type-tag" style={{ background: '#fff0e5', color: 'var(--orange)', borderRadius: '6px', padding: '5px 10px', fontSize: '12px', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '6px' }}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664zM21 12a9 9 0 11-18 0 9 9 0 0118 0z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
          YOUTUBE
        </div>
      ...
      <div className="pdf-content-area" style={{ flex: 1, padding: '32px 40px', overflowY: 'auto' }}>
        <div className="pdf-count-row" style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '24px' }}>
          <h2 className="pdf-section-title" style={{ fontSize: '20px', fontWeight: 600 }}>Youtube Videos</h2>
          ...
          {filtered.map(video => (
            <div key={video.id} className="video-item" style={{ display: 'flex', alignItems: 'center', gap: '16px', padding: '16px', border: '1px solid var(--gray-200)', borderRadius: '12px', background: 'var(--white)' }}>
              <div className="video-thumb" style={{ width: '72px', height: '54px', borderRadius: '6px', background: '#111', position: 'relative', overflow: 'hidden', flexShrink: 0 }}>
                ...
                <div style={{ position: 'absolute', left: '50%', top: '50%', transform: 'translate(-50%, -50%)', color: '#ff0000' }}>
