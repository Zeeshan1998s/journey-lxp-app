...
export default function RightSidebar({ onOpenChat, onOpenVideos }: { onOpenChat?: () => void, onOpenVideos?: () => void }) {
  return (
    <aside className="right-sidebar">
      <div className="rs-top-tabs">
        ...
        <button className="rs-tab" onClick={onOpenVideos}>
          Artefacts
        </button>
      </div>
      ...
      <div className="rs-panel">
        ...
        <ul className="content-list">
          ...
          <Link href="/pdfs" style={{textDecoration: 'none'}}>
            <li className="content-item">
